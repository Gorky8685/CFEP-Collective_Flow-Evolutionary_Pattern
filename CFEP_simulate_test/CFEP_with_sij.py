...
def generate_dendrogram(graph,after_graph,
    ...
    new_mod = __modularity(status,status_after, resolution, obj_func, obj_dir,current_graph, after_graph_copy, weight)
...
#     print('induced_graph',partition.values())
...
def __one_level(graph, graph_after, status, status_after, weight_key, resolution, random_state, obj_func, obj_dir,show_process):
    ...
    while stopping_criteria(stable_Q_list, check_continue_epoch=3):
